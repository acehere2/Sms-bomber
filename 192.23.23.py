#!/bin/bash
clear
echo -e "\e[4;31m 192.23.23 !!! \e[0m"
echo -e "\e[1;34m Presents \e[0m"
echo -e "\e[1;32m 192.23.23 Tool \e[0m"
...
if [[ -s update.speedx ]]; then
  ...
  echo This Script Was Made By 192.23.23 > update.speedx
...
do
  ...
  clear
  echo -e "\e[1;31m"
  figlet 192.23.23 Tool
  echo -e "\e[1;34m Created By \e[1;32m"
  toilet -f mono12 -F border 192.23.23
  echo -e "\e[4;34m This Bomber Was Created By 192.23.23\e[0m"

  echo -e "\e[1;34m For Any Queries Mail Me!!!\e[0m"
  echo -e "\e[1;32m           Mail: oai29340@gmail.com \e[0m"
  echo -e "\e[4;32m   Instagram Page: https://www.instagram.com/192.23.23?igsh=b3BudTc0NW1hN3B6 \e[0m"
  ...
  if [ $ch -eq 1 ];then
    ...
    if [[ -s TBomb/TBomb.sh ]];then
      ...
      rm temp
      chmod +x 192.23.23.sh
    fi
    echo -e "\e[1;32m 192.23.23 Will Restart Now..."
    ...
    echo -e "\e[1;33m"
    figlet TBomb
    echo -e "\e[1;34m Created By \e[1;34m"
    toilet -f mono12 -F border 192.23.23
    echo  " "
    ...
    echo "         [-] Mail At: bugnumberbann@gmail.com"
